...
export default async function CashierLayout({
    ...
    const navItems = [
        ...
        { href: "/cashier/fees", icon: IndianRupee, label: "Fee Collection" },
        { href: "/cashier/admission", icon: UserPlus, label: "New Admission" },
    ];
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-amber-900">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-lg font-semibold text-white">Cashier Portal</h1>
            ...
            <footer className="border-t border-slate-700 mt-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-slate-400 text-sm">
                    © 2026 RK Institute • Cashier Portal
                </div>
            </footer>
        </div>
    );
